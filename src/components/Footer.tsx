...
const Footer = (props: FooterProps) => {
  return (
    <footer className='className="h-[11dvh] light dark:background text-black dark:text-white w-full max-sm:px-3 flex justify-center'>
      <div className="relative layout-container mx-auto flex items-center py-4">
        ...
        <div className='rounded-full bg-black absolute top-[-1.5rem] right-2 w-12 h-12 p-2.5 hover:scale-125'>
