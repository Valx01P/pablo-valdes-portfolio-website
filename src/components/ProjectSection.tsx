      ...
      <div className='h-auto layout-container flex flex-col justify-center align-middle items-start px-4'>
        ...
        <div className='max-[1420px]:flex-col h-auto w-full flex flex-row mt-16 mb-4 p-8 light-card dark:background-card rounded-lg'>
          ...
          <div className='max-[1420px]:w-full flex max-[1420px]:items-center max-[1420px]:pt-8 flex-col items-start gap-4 roboto-medium w-1/2 px-4'>
            <h1 className='max-[430px]:text-2xl max-[450px]:text-center text-black dark:text-white text-4xl'>My Portfolio</h1>
            <p className='max-[430px]:text-xl max-[1420px]:w-auto flex max-[1420px]:text-balance max-[1420px]:text-center text-black dark:text-white text-2xl w-4/5'>The culmination of my skills & growing confidence as a Full Stack Web Developer.</p>
            ...
            <div className='flex max-[430px]:flex-col max-[430px]:items-center flex-row text-xl gap-4'>
              ...
              <div className='flex flex-row text-xl gap-4 items-center'>
              <Link href="/" >
        ...
        <div className='flex max-[1420px]:flex-col-reverse max-[1420px]:justify-center h-auto w-full flex-row my-4 p-8 light-card dark:background-card rounded-lg'>
          <div className='max-[1420px]:w-full flex max-[1420px]:items-center max-[1420px]:pt-8 flex-col items-start gap-4 roboto-medium w-1/2 px-4'>
            <h1 className='max-[430px]:text-2xl text-black dark:text-white text-4xl'>iServer</h1>
            <p className='max-[430px]:text-xl max-[1420px]:w-auto flex max-[1420px]:text-balance max-[1420px]:text-center text-black dark:text-white text-2xl w-4/5'>An image uploading website with third party auth, design inspired by imgbb.com. Made to statically serve image urls for websites.</p>
            <div className='flex flex-row flex-wrap justify-center gap-3 text-xl'>
              <div className='border-2 rounded-full border-transparent py-1 px-3 background text-white hover:scale-110'>
                Next.js
              </div>
        ...
        <div className='max-[1420px]:flex-col h-auto w-full flex flex-row my-4 p-8 light-card dark:background-card rounded-lg'>
          ...
          <div className='max-[1420px]:w-full flex max-[1420px]:items-center max-[1420px]:pt-8 flex-col items-start gap-4 roboto-medium w-1/2 px-4'>
            <h1 className='max-[430px]:text-2xl max-[450px]:text-center flex flex-wrap text-balance text-center justify-center text-black dark:text-white text-4xl'>Practical Synth Theme</h1>
            <p className='max-[430px]:text-xl max-[1420px]:w-auto max-[1420px]:text-balance max-[1420px]:text-center text-black dark:text-white text-2xl w-4/5'>My solution to a visually pleasing SynthWave Theme for Visual Studio Code. I could never find one I liked, so I made my own for everyday use.</p>
            <div className='flex flex-row flex-wrap justify-center gap-3 text-xl'>
              <div className='border-2 rounded-full border-transparent py-1 px-3 background text-white hover:scale-110'>
                CSS
              </div>
        ...
        <div className='flex max-[1420px]:flex-col-reverse max-[1420px]:justify-center h-auto w-full flex-row my-4 p-8 light-card dark:background-card rounded-lg'>
          <div className='max-[1420px]:w-full flex max-[1420px]:items-center max-[1420px]:pt-8 flex-col items-start gap-4 roboto-medium w-1/2 px-4'>
            <h1 className='max-[430px]:text-2xl max-[450px]:text-center flex flex-wrap text-balance text-center justify-center text-black dark:text-white text-4xl'>Theoretical Stonk Plays</h1>
            <p className='max-[430px]:text-xl max-[1420px]:w-auto flex max-[1420px]:text-balance max-[1420px]:text-center text-black dark:text-white text-2xl w-4/5'>My favorite project, uses a third party API to get stock aggregate data for charts. Allows user to form theoretical stock plays based on state actions.</p>
            <div className='flex flex-row flex-wrap justify-center gap-3 text-xl'>
              <div className='border-2 rounded-full border-transparent py-1 px-3 background text-white hover:scale-110'>
                Next.js
              </div>
        ...
        <div className='max-[1420px]:flex-col h-auto w-full flex flex-row my-4 p-8 light-card dark:background-card rounded-lg'>
          ...
          <div className='max-[1420px]:w-full flex max-[1420px]:items-center max-[1420px]:pt-8 flex-col items-start gap-4 roboto-medium w-1/2 px-4'>
            <h1 className='max-[430px]:text-2xl max-[450px]:text-center flex flex-wrap text-balance text-center justify-center text-black dark:text-white text-4xl'>General Planner</h1>
            <p className='max-[430px]:text-xl max-[1420px]:w-auto max-[1420px]:text-balance max-[1420px]:text-center text-black dark:text-white text-2xl w-4/5'>Authentication routes and permissions, a dedicated Frontend and Backend API. My first Full Stack project and a priceless learning experience.</p>
            <div className='flex flex-row flex-wrap max-[1120px]:justify-center justify-start gap-3 text-xl'>
              <div className='border-2 rounded-full border-transparent py-1 px-3 background text-white hover:scale-110'>
                React
              </div>
              <div className='border-2 rounded-full border-transparent py-1 px-3 background text-white hover:scale-110'>
