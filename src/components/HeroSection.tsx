...
const HeroSection = (props: HeroProps) => {
  ...
  return (
    <section id='hero' className="min-h-[100svh] pt-[clamp(1rem,4vw,4rem)] pb-[clamp(2rem,5vw,4rem)] w-full bg-transparent text-black dark:text-white flex justify-center items-center overflow-x-clip">
      <div className="layout-container mb-[10svh] flex flex-row max-[850px]:flex-col justify-between max-[850px]:justify-center items-center gap-x-6 gap-y-8 px-4">
        ...
        <div className='w-1/2 max-[850px]:w-full max-[850px]:mb-6 flex justify-center -translate-y-[2svh]'>
