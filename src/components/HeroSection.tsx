...
const HeroSection = (props: HeroProps) => {
  ...
  return (
    <section id='hero' className="h-auto max-[1500px]:pt-0 max-[1550px]:pt-8 pt-16 pb-16 w-full light dark:background text-black dark:text-white flex justify-center items-center ">
